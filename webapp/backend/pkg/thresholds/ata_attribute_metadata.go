...
var AtaDeviceStatsMetadata = map[string]AtaDeviceStatisticsMetadata{
	...
	"devstat_5_88": {
		DisplayName: "Time in Over-temperature",
		Ideal:       ObservedThresholdIdealLow,
		Critical:    false,
	...
	"devstat_4_16": {
		DisplayName: "Number of Interface CRC Errors",
		Ideal:       ObservedThresholdIdealLow,
		Critical:    false,
		Description: "Number of interface CRC errors detected (may indicate cable issues).",
		DisplayType: AtaSmartAttributeDisplayTypeRaw,
	},
	// Page 6 (Transport Statistics)
	"devstat_6_8": {
		DisplayName: "Number of Hardware Resets",
		Ideal:       ObservedThresholdIdealLow,
		Critical:    false,
		Description: "Number of hardware reset events received by the device.",
		DisplayType: AtaSmartAttributeDisplayTypeRaw,
	},
	"devstat_6_16": {
		DisplayName: "Number of ASR Events",
		Ideal:       ObservedThresholdIdealLow,
		Critical:    false,
		Description: "Number of Asynchronous Signal Recovery events.",
		DisplayType: AtaSmartAttributeDisplayTypeRaw,
	},
	"devstat_6_24": {
		DisplayName: "Number of Interface CRC Errors (Transport)",
		Ideal:       ObservedThresholdIdealLow,
		Critical:    false,
		Description: "Number of interface CRC errors from transport statistics.",
		DisplayType: AtaSmartAttributeDisplayTypeRaw,
	},
}
