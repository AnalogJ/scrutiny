...
var AtaDeviceStatsMetadata = map[string]AtaDeviceStatisticsMetadata{
	...
	// Page 3 (Rotating Media Statistics) - for HDDs
	"devstat_3_8": {
		DisplayName: "Spindle Motor Power-on Hours",
		Ideal:       "",
		Critical:    false,
	...
	"devstat_3_16": {
		...
		Ideal:       "",
		Critical:    false,
		Description: "Total hours the heads have been flying over the media.",
		DisplayType: AtaSmartAttributeDisplayTypeRaw,
	},
	"devstat_3_24": {
		...
		Ideal:       "",
		Critical:    false,
		Description: "Number of head load events (head moves from parked to active).",
		DisplayType: AtaSmartAttributeDisplayTypeRaw,
	},
	"devstat_3_32": {
		DisplayName: "Number of Reallocated Logical Sectors",
		Ideal:       ObservedThresholdIdealLow,
		Critical:    true,
		Description: "Number of logical sectors that have been reallocated due to defects.",
		DisplayType: AtaSmartAttributeDisplayTypeRaw,
	},
	"devstat_3_40": {
		DisplayName: "Read Recovery Attempts",
		Ideal:       ObservedThresholdIdealLow,
		Critical:    false,
		Description: "Number of read recovery attempts performed.",
		DisplayType: AtaSmartAttributeDisplayTypeRaw,
	},
	"devstat_3_48": {
		DisplayName: "Number of Mechanical Start Failures",
		Ideal:       ObservedThresholdIdealLow,
		Critical:    true,
		Description: "Number of times the spindle motor failed to reach operating speed.",
		DisplayType: AtaSmartAttributeDisplayTypeRaw,
	},
	"devstat_3_56": {
		DisplayName: "Number of Reallocation Candidate Logical Sectors",
		Ideal:       ObservedThresholdIdealLow,
		Critical:    true,
		Description: "Number of logical sectors waiting to be reallocated.",
		DisplayType: AtaSmartAttributeDisplayTypeRaw,
	},
	"devstat_3_64": {
		DisplayName: "Number of High Priority Unload Events",
		Ideal:       ObservedThresholdIdealLow,
		Critical:    false,
		Description: "Number of emergency head unloads due to shock detection or errors.",
		DisplayType: AtaSmartAttributeDisplayTypeRaw,
	},
	// Page 5 (Temperature Statistics) - additional entries
	"devstat_5_48": {
		DisplayName: "Highest Average Short-term Temperature",
		Ideal:       "",
		Critical:    false,
		Description: "Highest average short-term temperature recorded.",
		DisplayType: AtaSmartAttributeDisplayTypeRaw,
	},
	"devstat_5_56": {
		DisplayName: "Lowest Average Short-term Temperature",
		Ideal:       "",
		Critical:    false,
		Description: "Lowest average short-term temperature recorded.",
		DisplayType: AtaSmartAttributeDisplayTypeRaw,
	},
	"devstat_5_64": {
		DisplayName: "Highest Average Long-term Temperature",
		Ideal:       "",
		Critical:    false,
		Description: "Highest average long-term temperature recorded.",
		DisplayType: AtaSmartAttributeDisplayTypeRaw,
	},
	"devstat_5_72": {
		DisplayName: "Lowest Average Long-term Temperature",
		Ideal:       "",
		Critical:    false,
		Description: "Lowest average long-term temperature recorded.",
		DisplayType: AtaSmartAttributeDisplayTypeRaw,
	},
	"devstat_5_80": {
		DisplayName: "Time in Under-temperature",
		Ideal:       ObservedThresholdIdealLow,
		Critical:    false,
		Description: "Time in minutes the device has operated below minimum recommended temperature.",
		DisplayType: AtaSmartAttributeDisplayTypeRaw,
	},
	"devstat_5_96": {
		DisplayName: "Specified Maximum Operating Temperature",
		Ideal:       "",
		Critical:    false,
		Description: "Maximum operating temperature specified by the manufacturer.",
		DisplayType: AtaSmartAttributeDisplayTypeRaw,
	},
	"devstat_5_104": {
		DisplayName: "Specified Minimum Operating Temperature",
		Ideal:       "",
		Critical:    false,
